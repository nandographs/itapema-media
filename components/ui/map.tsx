...
type MapProps = {
    children?: ReactNode;
    /** Force a specific theme. Defaults to "dark". */
    theme?: "light" | "dark";
...
const DefaultLoader = () => (
    <div className="absolute inset-0 flex items-center justify-center">
        <div className="flex gap-1">
            <span className="size-1.5 rounded-full bg-zinc-400/60 animate-pulse" />
            <span className="size-1.5 rounded-full bg-zinc-400/60 animate-pulse [animation-delay:150ms]" />
            <span className="size-1.5 rounded-full bg-zinc-400/60 animate-pulse [animation-delay:300ms]" />
        </div>
    </div>
);

function Map({ children, theme = "dark", styles, ...props }: MapProps) {
...
function ControlGroup({ children }: { children: ReactNode }) {
    return (
        <div className="flex flex-col rounded-md border border-white/10 bg-zinc-900 shadow-sm overflow-hidden [&>button:not(:last-child)]:border-b [&>button:not(:last-child)]:border-white/10">
            {children}
        </div>
    );
}
...
function ControlButton({
    ...
    return (
        <button
            ...
            type="button"
            className={cn(
                "flex items-center justify-center size-8 text-white hover:bg-white/10 transition-colors",
    ...
    return (
        <ControlButton onClick={onClick} label="Reset bearing to north">
            ...
            >
                ...
                <path d="M12 22L16 12H12V22Z" className="fill-zinc-500" />
                <path d="M12 22L8 12H12V22Z" className="fill-zinc-700" />
            </svg>
        </ControlButton>
    );
}
